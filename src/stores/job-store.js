...
export const useJobsStore = defineStore('jobs', {
  ...
  actions: {
    ...
    async fetchRecommendedJobs() {
      this.loading = true
      this.message = ''
      this.recommendedJobs = [] // ✅ clear recommended list only

      console.log('[JobsStore] fetchRecommendedJobs called')
      ...
      try {
        ...
        console.log('[JobsStore] recommended jobs:', data.jobs?.length || 0)

        this.recommendedJobs = data.jobs || [] // ✅ assign to recommendedJobs
        ...
        console.error('[JobsStore] Job fetch error:', err)
      } finally {
        this.loading = false
      }
    },
