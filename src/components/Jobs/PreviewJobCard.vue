      ...
      <q-card class="inner-job-card q-py-xs q-px-md q-mx-none" flat bordered>
        <div class="row q-col-gutter-sm items-center justify-between">
          ...
          <div class="col-8 col-md-8">
            ...
            <div class="job-meta">{{ jobData.location }} • ₹{{ jobData.salary }}L</div>
          </div>
          ...
          <div class="col-4 col-md-4 text-right">
            <div class="row items-center justify-end q-gutter-sm no-wrap">
              <div>
                ...
                <div class="text-caption text-grey-6">Posted {{ jobData.posted }}</div>
              </div>
              <q-btn flat dense label="Apply" class="btn-outline-black equal-button" />
              <q-btn
                unelevated
                dense
                label="Learn"
...
import demoLogo from '../../assets/logo.png'
