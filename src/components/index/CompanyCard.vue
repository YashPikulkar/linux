...
const handleViewCompany = () => {
  if (!props.company || !props.company.cid) {
    console.warn('Company ID (cid) is missing!')
    return
  }

  // ✅ set selectedCompany in store before routing
  jobsStore.selectedCompany = props.company
...
.company-card:hover {
  ...
  box-shadow:
    ...
    /* Copper-tinted shadow */ 0 10px 10px -5px rgba(0, 119, 182, 0.15); /* Softer shadow */
}
...
.company-card:hover .company-initials {
  ...
  box-shadow: 0 4px 12px rgba(0, 119, 182, 0.4); /* Copper glow */
}
...
.view-company-btn:active {
  ...
  box-shadow: 0 2px 6px rgba(0, 119, 182, 0.3); /* Softer shadow */
}
