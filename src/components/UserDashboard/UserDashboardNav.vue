<template>
  <div class="dashboard-wrapper">
    ...
    <div class="user-dashboard-nav">
      <div class="nav-icon-btn" @click="setActive('Home')">
      ...
      <div class="nav-icon-btn" @click="setActive('Tracker')">
    ...
    <q-menu v-model="menuVisible" class="user-menu">
      <q-list class="menu-list">
        ...
        <q-item clickable v-ripple @click="setActive('Profile')" class="menu-item">
    ...
    <div class="dashboard-content" v-show="activeView === 'Home'">
      <component :is="DashboardHome" />
    </div>-->

    <!-- Modal Overlay for non-Home views -->
    <div
...
// ✅ Correct imports (NOT a page as component)
import DashboardHome from 'src/pages/UserDashboard.vue'
import DashboardJobs from 'src/components/Jobs/JobList.vue'
import DashboardNotifications from 'src/components/UserDashboard/notification/DashboardNotification.vue'
import DashboardTracker from 'src/components/UserDashboard/ApplicationStatus/ApplicationStatus.vue'
import UserProfile from 'src/components/UserDashboard/TopSection/TopSection.vue'
import UserSettings from 'src/components/settings.vue'

const activeView = ref('Home') // Default to Home view - hidden by default
...
function setActive(view) {
  ...
  // For other views, show modal with animations
...
function closeModal() {
  ...
  // Wait for exit animation to complete before returning to Home
  setTimeout(() => {
    activeView.value = 'Home'
    isExiting.value = false
  }, 300)
...
const activeComponent = computed(() => {
  if (!activeView.value || activeView.value === 'Home') return null
